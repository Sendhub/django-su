...
if django.VERSION[:2] < (1, 5):  # pragma: no cover
...
if django.VERSION[:2] < (1, 6):  # pragma: no cover
    ...
    def import_by_path(dotted_path, error_prefix=""):
        ...
        try:
            ...
            raise ImproperlyConfigured('%sModule "%s" does not define a "%s" attribute/class' % (error_prefix, module_path, class_name))
        return attr

elif django.VERSION[:2] < (1, 8):  # pragma: no cover
    pass
