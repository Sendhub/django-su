...
from django.contrib.auth import BACKEND_SESSION_KEY, SESSION_KEY, authenticate, get_user_model, login
...
def login_as_user(request, user_id):
    ...
    exit_users_pk.append((request.session[SESSION_KEY], request.session[BACKEND_SESSION_KEY]))
